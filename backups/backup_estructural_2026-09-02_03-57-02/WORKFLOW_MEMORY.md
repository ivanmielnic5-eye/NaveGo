...
SIMULADOR — Estado actual (2026-09-02)

Configuración estable:

- Flotabilidad: float_cube.gd (float_force = 700) ✅
- Control (WASD): main.gd (funcional) ✅
- Viento: win_controller.gd (mueve el barco) ✅
- HUD (SOG, COG, HDG): Monitor.gd (funcional) ✅
- Grilla de referencia: grid_reference.gd (visible) ✅
- AWS / AWA: HeadingWindIntegrator.gd (pendiente) ⏳
- Duplicación en HUD: eliminada ✅

Scripts clave (backup realizado):
...
Backup realizado en:
C:\Users\ivan\OneDrive\Documentos\matris-sandbox\simulador_limpio\backup_estable_2026-09-02_*

Próximo paso (mañana):
1. Revisar HeadingWindIntegrator.gd para que lea wind_speed y wind_direction desde win_controller.gd.
2. Implementar sistema de versionado de scripts (PowerShell) para no perder avances.
